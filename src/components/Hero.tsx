...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-onion-50 via-white to-earth-50 flex items-center">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-onion-600 font-medium">
                <MapPin className="w-5 h-5" />
                <span>From Nashik, Maharashtra, India</span>
              </div>
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Premium <span className="text-onion-600">Red Onions</span> for Global Markets
              </h1>
            ...
            <div className="grid grid-cols-3 gap-6 py-6">
              <div className="text-center">
                <div className="flex items-center justify-center w-16 h-16 bg-onion-100 rounded-full mx-auto mb-3">
                  <Award className="w-8 h-8 text-onion-600" />
                </div>
                <p className="text-sm font-medium text-gray-700">Premium Quality</p>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center w-16 h-16 bg-earth-100 rounded-full mx-auto mb-3">
                  <Truck className="w-8 h-8 text-earth-600" />
                </div>
            ...
            <div className="space-y-4">
              <Button 
                ...
                className="bg-onion-600 hover:bg-onion-700 text-white px-8 py-4 text-lg font-semibold rounded-lg transition-colors duration-300"
              >
                Get Quote Now
              </Button>
          ...
          <div className="relative">
            <div className="aspect-square bg-gradient-to-br from-onion-100 to-earth-100 rounded-3xl p-8 shadow-2xl">
              <img 
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border">
              <div className="text-center">
                <p className="text-3xl font-bold text-onion-600">15+</p>
